...
public class InventoryTracker {
	...
	private void checkItemInHand(Player p, long time) {
		...
		if (itemType.equals(previousType)==false) {
			...
			LogEvent logEvent = new LogEvent("PlayerItemInHandEvent", time, epilog.activeMazeEscapeGameData != null ? epilog.activeMazeEscapeGameData.getTeamID() : null, p);
	...
	private void checkInventory(String eventName, Player player, long time, Map<UUID, InventoryContent> state, ItemStack[] content) {
		...
		LogEvent logEvent = new LogEvent(eventName, time, epilog.activeMazeEscapeGameData != null ? epilog.activeMazeEscapeGameData.getTeamID() : null, player);
	...
	private void checkChest(Location location, Player player, long time, ItemStack[] content) {
		...
		LogEvent logEvent = new LogEvent("ChestContent", time, epilog.activeMazeEscapeGameData != null ? epilog.activeMazeEscapeGameData.getTeamID() : null, player);
