...
function createD3RangeSlider(rangeMin, rangeMax, containerSelector, playButton) {
    ...
    var slider = sliderBox
        .append("div")
        .attr("class", "slider");
    // var handleW = slider.append("div").attr("class", "handle WW").attr("id","W");
    var handleE = slider.append("div").attr("class", "handle EE").attr("id","E");
    ...
    var dragResizeE = d3.drag()
        ...
        .on("drag", function (event) {
            // console.log('R', event.dx)
            // console.log('R', d3.pointer(event))
    ...
    //         // // var dx = d3.pointer(event)[0]; // - this.startX
    //         // var dx = event.dx;
    //         // if (dx == 0) return;
    ...
    //         // // console.log(slider.style("left"), slider.style("width"))
    //         // // console.log(dx)

    //         // // slider.style("left", (slider.style("left") + dx) + "px")
    //         // // slider.style("width", slider.style("width") - dx)

    //         // updateRangeFromUI();

    //         // console.log('L', event.dx)
    //         // console.log('L', d3.pointer(event))
    ...
    //         // // newWidth = Math.max(newWidth, minWidth);
    //         // // newWidth = Math.min(newWidth, conWidth - newLeft);
    //         // slider.style("left", (parseInt(slider.style("left")) + dx) + "px")
    //         // // slider.style("width", newWidth + "px");
    //         // updateRangeFromUI();
    //     });
